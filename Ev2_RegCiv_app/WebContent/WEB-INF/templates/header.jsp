...
<body>
	<header>
		<nav class="navbar has-background-info has-text-white" role="navigation" aria-label="main navigation">
			<div class="navbar-brand">
    			<a class="navbar-item" href="index.jsp"><img src="img/MLP.png"></a>
